                ...
                {activeMode === "counseling" ? (
                  ...
                  >
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
                      Have questions about our syllabus, job assistance, or which engineering program is right for you? Fill out the form and our mentors will connect with you.
                    </p>
                  </motion.div>
                ) : (
                  <motion.div
                  ...
                  >
                    <span className="mb-4 inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-4 py-1.5 text-xs font-semibold text-primary">
                      ...
                      Startup Studio Partnership
                    </span>
                    <h1 className="mb-4 font-display text-4xl font-extrabold tracking-tight sm:text-5xl">
                      Let's Build Your <span className="text-primary">MVP Together</span>
                    </h1>
                    <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
                      Have a startup idea or a scaling bottleneck? Connect with our Startup Studio to get elite fractional tech talent, rapid development, and architecture blueprints.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <div className="lg:col-span-7">
                ...
                >
                  <h2 className="mb-2 font-display text-xl font-bold tracking-tight">
                    {activeMode === "counseling" ? "Book a Free Counseling Session" : "Request a Discovery Call"}
                  </h2>
                  <p className="mb-6 text-sm text-muted-foreground">
                    {activeMode === "counseling" 
                      ? "Submit your details and select a course to schedule a 1-on-1 strategy call with our mentors."
                      : "Share your business details or concerns. We typically respond within 2-4 business hours."
                    }
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a 
                          href={activeMode === "counseling" ? "mailto:contact@levelupengineers.com" : "mailto:studio@levelupengineers.com"}
                          className="text-sm font-semibold hover:text-primary transition-colors duration-200"
                        >
                          {activeMode === "counseling" ? "contact@levelupengineers.com" : "studio@levelupengineers.com"}
                        </a>
                      </div>
                    </div>
                  ...
                  {activeMode === "counseling" ? (
                    ...
                    >
                      <div className="mb-4 flex items-center gap-2 text-primary">
                        ...
                        <h3 className="font-display font-bold">Why Join Level Up Engineers?</h3>
                      </div>
                    ...
                    >
                      <div className="mb-4 flex items-center gap-2 text-primary">
                        <Sparkles className="h-5 w-5" />
                        <h3 className="font-display font-bold">Startup Studio Engagement</h3>
                      </div>
                      <ul className="space-y-3.5 text-sm">
                        {[
